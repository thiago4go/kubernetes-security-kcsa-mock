export const Kubernetes_Security_Fundamentals = [
  {
    ...
    "answer": 0,
    "explanation": "Network Policies are implemented through the Container Network Interface (CNI) plugin and typically use iptables rules to enforce traffic restrictions between pods. They allow fine-grained control over which pods can communicate with each other based on labels, namespaces, and IP blocks."
  },
  {
    "id": 2,
