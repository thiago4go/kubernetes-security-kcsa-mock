    ...
    },
    {
      ...
      "subdomain": "Observability"
        ...
        },
        {
          ...
          "correct_answers": [1],
          "explanation": "The 'kubectl get --raw='/readyz?verbose'' command shows component statuses.",
          "question_type": "single-choice",
          "domain": "Platform Security",
          "subdomain": "Observability"
        },
        ...
        },
        {
          ...
          },
          {
            ...
            "correct_answers": [0],
            "explanation": "openssl genrsa generates a new RSA private key.",
            "question_type": "single-choice",
            "domain": "Platform Security",
            "subdomain": "PKI"
          },
          {
            ...
            "correct_answers": [0],
            "explanation": "Use 'kubectl config set-credentials' with the certificate and key.",
            "question_type": "single-choice",
            "domain": "Platform Security",
            "subdomain": "PKI"
          },
          {
            ...
            "correct_answers": [1],
            "explanation": "CertificateSigningRequest is used to request signing of a certificate.",
            "question_type": "single-choice",
            "domain": "Platform Security",
            "subdomain": "PKI"
          },
          {
            ...
            "correct_answers": [3],
            "explanation": "The correct command is 'kubectl certificate approve <csr-name>'.",
            "question_type": "single-choice",
            "domain": "Platform Security",
            "subdomain": "PKI"
          },
          {
            ...
            "correct_answers": [0],
            "explanation": "sudo netstat -tulpn lists all listening TCP/UDP ports with process IDs.",
            "question_type": "single-choice",
            "domain": "Platform Security",
            "subdomain": "Connectivity"
          },
          {
            ...
            "correct_answers": [3],
            "explanation": "sudo kill <pid> terminates the process with the specified PID.",
            "question_type": "single-choice",
            "domain": "Platform Security",
            "subdomain": "Connectivity"
          },
          ...
          },
          {
            ...
            "correct_answers": [0],
            "explanation": "apt list --installed lists all packages installed via apt.",
            "question_type": "single-choice",
            "domain": "Platform Security",
            "subdomain": "Supply Chain Security"
          },
          {
            ...
            "correct_answers": [0],
            "explanation": "The '-c' option produces a summary of system calls and timing.",
            "question_type": "single-choice",
            "domain": "Platform Security",
            "subdomain": "Observability"
          },
          {
            ...
            "correct_answers": [1],
            "explanation": "strace -p 1234 attaches to the running process with PID 1234.",
            "question_type": "single-choice",
            "domain": "Platform Security",
            "subdomain": "Observability"
          },
          ...
          },
          {
            ...
            "correct_answers": [1],
            "explanation": "Verifying checksums confirms that the binaries have not been tampered with.",
            "question_type": "single-choice",
            "domain": "Platform Security",
            "subdomain": "PKI"
          },
          {
            ...
            "correct_answers": [1],
            "explanation": "kubectl apply -f deployment.yaml applies the configuration changes.",
            "question_type": "single-choice",
            "domain": "Platform Security",
            "subdomain": "Observability"
          },
          {
            ...
            "correct_answers": [1],
            "explanation": "A Service Mesh provides an infrastructure layer for secure and observable service-to-service communication.",
            "question_type": "single-choice",
            "domain": "Platform Security",
            "subdomain": "Service Mesh"
          },
          {
            ...
            "correct_answers": [0, 2],
            "explanation": "Service Mesh improves observability and security (e.g. via mutual TLS), though it can add overhead.",
            "question_type": "multiple-choice",
            "domain": "Platform Security",
            "subdomain": "Service Mesh"
          },
          {
          ...
          },
            {
              ...
              "options": "[\"HorizontalPodAutoscaler\",\"VerticalPodAutoscaler\",\"ResourceQuota\",\"LimitRange\",\"Deployment\"]",
              "correct_answers": "[0]",
            ...
            },
            {
              ...
              "options": "[\"kubectl get node <node-name>\",\"kubectl describe node <node-name>\",\"kubectl inspect node <node-name>\",\"kubectl info node <node-name>\",\"kubectl logs node <node-name>\"]",
              "correct_answers": "[1]",
            ...
            },
            {
              "id": 199,
              "question": "Which command can be used to apply a configuration change to a resource defined in 'deployment.yaml'?",
              "options": "[\"kubectl create -f deployment.yaml\",\"kubectl apply -f deployment.yaml\",\"kubectl set -f deployment.yaml\",\"kubectl update -f deployment.yaml\",\"kubectl replace -f deployment.yaml\"]",
              "correct_answers": "[1]",
            ...
            },
            {
              ...
              "options": "[\"sudo apparmor_status\",\"sudo aa-enforce\",\"sudo apparmor_parser -L\",\"sudo aa-status\",\"sudo systemctl status apparmor\"]",
              "correct_answers": "[3]",
            ...
            },
            {
              ...
              "options": "[\"Set the profile in the Pod's securityContext\",\"Annotate each container with the AppArmor profile\",\"Use the 'apparmorProfile' field in the container spec\",\"Specify the profile in the Deployment's metadata\",\"Set the profile in the node's AppArmor configuration\"]",
              "correct_answers": "[1]",
            ...
            },
            {
              "id": 300,
              "question": "Which command can be used to set the default namespace for kubectl commands?",
              "options": "[\"kubectl config use-context <namespace>\",\"kubectl set namespace <namespace>\",\"kubectl config set-context --current --namespace=<namespace>\",\"kubectl namespace set <namespace>\",\"kubectl switch namespace <namespace>\"]",
              "correct_answers": "[2]",
              "explanation": "This command sets the default namespace in the current context.",
              "question_type": "single-choice",
              "domain": "Platform Security",
            ...
            },
            {
              "id": 206,
              "question": "Which command is used to generate a private key for a new Kubernetes user?",
              "options": "[\"openssl genrsa -out user.key 2048\",\"openssl rsa -in user.key -out user.key\",\"openssl req -newkey rsa:2048 -nodes -keyout user.key -out user.csr\",\"kubectl create secret tls user.key\",\"ssh-keygen -t rsa -b 2048 -f user.key\"]",
              "correct_answers": "[0]",
              "explanation": "The command 'openssl genrsa -out user.key 2048' generates a 2048-bit RSA private key.",
              "question_type": "single-choice",
              "domain": "Platform Security",
            ...
            },
            {
              "id": 207,
              "question": "After generating a CSR and signing it with the cluster CA, how do you configure kubectl to use the new certificate for user 'alice'?",
              "options": "[\"kubectl config set-credentials alice --client-certificate=alice.crt --client-key=alice.key\",\"kubectl create secret tls alice --cert=alice.crt --key=alice.key\",\"kubectl config set-context alice-context --cluster=kubernetes --user=alice\",\"kubectl apply -f alice.crt\",\"kubectl certificate approve alice\"]",
              "correct_answers": "[0]",
            ...
            },
            {
              "id": 236,
              "question": "Which Kubernetes resource is used to request certificate signing via the Kubernetes API?",
              "options": "[\"CertificateRequest\",\"CertificateSigningRequest\",\"CertificateApproval\",\"CertificateSigning\",\"Certificate\"]",
              "correct_answers": "[1]",
            ...
            },
            {
              "id": 237,
              "question": "After creating a CSR object in Kubernetes, which command is used to approve it?",
              "options": "[\"kubectl sign csr <csr-name>\",\"kubectl create csr <csr-name>\",\"kubectl approve csr <csr-name>\",\"kubectl certificate approve <csr-name>\",\"kubectl csr approve <csr-name>\"]",
              "correct_answers": "[3]",
              "explanation": "The command 'kubectl certificate approve <csr-name>' approves the CSR.",
              "question_type": "single-choice",
              "domain": "Platform Security",
            ...
            },
            {
              "id": 240,
              "question": "Which command lists all processes listening on TCP and UDP ports?",
              "options": "[\"sudo netstat -tulpn\",\"sudo lsof -i\",\"sudo ss -tulw\",\"sudo ps aux | grep LISTEN\",\"sudo netstat -an\"]",
              "correct_answers": "[0]",
            ...
            },
            {
              "id": 241,
              "question": "After identifying an unwanted process listening on a port, which command can you use to stop it?",
              "options": "[\"killall <process-name>\",\"sudo stop <process-name>\",\"sudo systemctl disable <process-name>\",\"sudo kill <pid>\",\"sudo service <process-name> remove\"]",
              "correct_answers": "[3]",
            ...
            },
            {
              "id": 242,
              "question": "Which command can be used to remove an unwanted package 'apache2' from a Debian-based system?",
              "options": "[\"sudo apt-get install apache2\",\"sudo yum remove apache2\",\"sudo apt-get remove apache2\",\"sudo rpm -e apache2\",\"sudo dnf erase apache2\"]",
              "correct_answers": "[2]",
              "explanation": "On Debian-based systems, 'sudo apt-get remove apache2' removes the package.",
              "question_type": "single-choice",
              "domain": "Platform Security",
            ...
            },
            {
              "id": 243,
              "question": "Which command lists all installed packages on a Debian-based system using apt?",
              "options": "[\"apt list --installed\",\"dpkg -l\",\"rpm -qa\",\"yum list installed\",\"pkg info\"]",
              "correct_answers": "[0]",
            ...
            },
            {
              "id": 245,
              "question": "To trace system calls made by a running process with PID 1234, which command would you use?",
              "options": "[\"strace 1234\",\"strace -p 1234\",\"strace -c 1234\",\"sudo trace -pid 1234\",\"strace --process 1234\"]",
              "correct_answers": "[1]",
              "explanation": "The 'strace -p 1234' command attaches to the process with PID 1234.",
              "question_type": "single-choice",
              "domain": "Platform Security",
            ...
            },
            {
              "id": 247,
              "question": "Why is it important to verify the checksums of Kubernetes binaries?",
              "options": "[\"To ensure they are the latest version\",\"To verify the integrity and authenticity of the binaries\",\"To improve their performance\",\"To check for syntax errors\",\"To enable automatic updates\"]",
              "correct_answers": "[1]",
            ...
            },
            {
              "id": 289,
              "question": "What is a Service Mesh in Kubernetes?",
              "options": "[\"A network overlay for pod communication\",\"An infrastructure layer for handling service-to-service communication\",\"A type of storage solution\",\"A container runtime interface\",\"A logging mechanism\"]",
              "correct_answers": "[1]",
            ...
            },
            {
              "id": 290,
              "question": "Which of the following are advantages of using a Service Mesh? (Select all that apply)",
              "options": "[\"Observability\",\"Simplifies application code\",\"Enhanced security with mutual TLS\",\"Adds significant overhead\",\"Requires no additional expertise\"]",
              "correct_answers": "[0,2]",
